    ...
    public static Card getCard(Fruit name)
    {
        ...
        switch(card.getName())
        {
            ...
            case laranja:
                ...
                break;
            case limao:
                card.setButton(new CardButton(new ImageIcon(new ImageIcon("models.basic_img/Limão_.png").getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH))));
                card.setAttack(1);
                card.setHp(1);
                card.setCost(1);
                card.setType(Type.Basic);
                break;
            case mamao:
                card.setButton(new CardButton(new ImageIcon(new ImageIcon("models.basic_img/Mamão_.png").getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH))));
                card.setAttack(3);
                card.setHp(2);
                card.setCost(2);
                card.setType(Type.Basic);
            ...
            case manga:
                ...
                break;
            case maracuja:
                card.setButton(new CardButton(new ImageIcon(new ImageIcon("models.basic_img/Maracujá.png").getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH))));
                card.setAttack(4);
                card.setHp(2);
                card.setCost(4);
                card.setType(Type.Basic);
                break;
            case maca:
                card.setButton(new CardButton(new ImageIcon(new ImageIcon("models.basic_img/Maçã_.png").getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH))));
                card.setAttack(2);
                card.setHp(1);
                card.setCost(1);
                card.setType(Type.Basic);
            ...
            case pera:
                ...
                break;
            case pessego:
                card.setButton(new CardButton(new ImageIcon(new ImageIcon("models.basic_img/Pêssego_.png").getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH))));
                card.setAttack(1);
                card.setHp(4);
                card.setCost(3);
                card.setType(Type.Basic);
                break;
            case roma:
                card.setButton(new CardButton(new ImageIcon(new ImageIcon("models.basic_img/Romã.png").getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH))));
                card.setAttack(3);
                card.setHp(4);
                card.setCost(4);
                card.setType(Type.Basic);
